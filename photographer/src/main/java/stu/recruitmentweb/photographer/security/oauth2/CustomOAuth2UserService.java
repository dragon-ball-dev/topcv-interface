package stu.recruitmentweb.photographer.security.oauth2;
...
import stu.recruitmentweb.photographer.domain.enums.AuthProvider;
...
import stu.recruitmentweb.photographer.exception.OAuth2AuthenticationProcessingException;
import stu.recruitmentweb.photographer.repository.JobseekerRepository;
import stu.recruitmentweb.photographer.repository.RoleRepository;
...
import stu.recruitmentweb.photographer.security.oauth2.user.OAuth2UserInfo;
import stu.recruitmentweb.photographer.security.oauth2.user.OAuth2UserInfoFactory;
